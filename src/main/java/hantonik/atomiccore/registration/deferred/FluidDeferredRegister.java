...
//        return register(name, tagName, new FluidBuilder(builder).explosionResistance(100F), still, flowing, (fluid) -> new LiquidBlock(fluid, Block.Properties.of(material).air().strength(100.0F).noLootTable().lightLevel((state) -> lightLevel)));
//    }
//
